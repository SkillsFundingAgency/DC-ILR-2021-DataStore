...
namespace ESFA.DC.ILR1920.DataStore.EF
{
    public partial class FM35_LearningDelivery
    {
        ...
        {
            FM35_LearningDelivery_PeriodisedValues = new HashSet<FM35_LearningDelivery_PeriodisedValue>();
            FM35_LearningDelivery_Periods = new HashSet<FM35_LearningDelivery_Period>();
        }
