...
{
    public class FM81Transation : ITableSetTransaction
    {
        private readonly IPersistenceService _persistenceService;
        private readonly ILogger _logger;

        public int TaskOrder => 8;

        public string TaskKey => TaskNameConstants.TaskStoreFM81Tables;

        public FM81Transation(
        ...
        {
            await _persistenceService.PersistFM81DataAsync(cache, connection, transaction, cancellationToken);
