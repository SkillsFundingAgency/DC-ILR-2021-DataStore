...
namespace ESFA.DC.ILR1819.DataStore.PersistData.Test.StoreTests
{
    ...
    public class TestStoreFM36 : AbstractIlrStoreTest<FM36Global>
    {
        ...
        private static StoreFM36 StoreFM36Setup()
        {
            ...
            var global = new List<AEC_global>() { fundingOutput };
            ...
            fm36MapperMock.Setup(fm => fm.MapGlobals(_fundingOutputs)).Returns(global);
