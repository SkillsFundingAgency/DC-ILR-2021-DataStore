...
namespace ESFA.DC.ILR1819.DataStore.PersistData.Test
{
    public sealed class TestStoreIlr
    {
        ...
        [Theory]
        [InlineData("ILR-90000077-1819-20180516-122452-02.xml", "ALBOutput1000.json", 90000077, "0Accm01")]
        [InlineData("ILR-90000078-1819-20180518-094937-02.xml", "ALBOutput1000.json", 90000078, "0fm3501")]
        [InlineData("ILR-90000079-1819-20180518-094943-02.xml", "ALBOutput1000.json", 90000079, "0fm3501")]
        [InlineData("ILR-90000080-1819-20180518-094947-02.xml", "ALBOutput1000.json", 90000080, "0fm3501")]
        [InlineData("ILR-90000081-1819-20180518-095009-02.xml", "ALBOutput1000.json", 90000081, "0fm3501")]
        [InlineData("ILR-90000065-1819-20180518-095236-02.xml", "ALBOutput1000.json", 90000065, "0Accm01")]
        [InlineData("ILR-90000066-1819-20180518-095239-02.xml", "ALBOutput1000.json", 90000066, "0Accm01")]
        [InlineData("ILR-90000067-1819-20180518-095243-02.xml", "ALBOutput1000.json", 90000067, "0Accm01")]
        [InlineData("ILR-90000068-1819-20180518-095303-02.xml", "ALBOutput1000.json", 90000068, "0Accm01")]
        [InlineData("ILR-90000071-1819-20180518-095441-02.xml", "ALBOutput1000.json", 90000071, "0Accm01")]
        [InlineData("ILR-90000072-1819-20180518-095444-02.xml", "ALBOutput1000.json", 90000072, "0Accm01")]
        [InlineData("ILR-90000073-1819-20180518-095504-02.xml", "ALBOutput1000.json", 90000073, "0Accm01")]
        [InlineData("ILR-90000074-1819-20180521-132627-00.xml", "ALBOutput1000.json", 90000074, "0Accm01")]
        [InlineData("ILR-90000075-1819-20180521-132931-00.xml", "ALBOutput1000.json", 90000075, "0Accm01")]
        ...
        public async Task StoreIlr(string ilrFilename, string albDataFilename, int ukPrn, string validLearner)
        {
            ...
            Task<Tuple<Message, FundingOutputs>> reandAndSerialiseTask = ReadAndDeserialiseAsync(ilrFilename, albDataFilename, jobContextMessage, validLearners, storage, persist, serialise);
        ...
        private async Task<Tuple<Message, FundingOutputs>> ReadAndDeserialiseAsync(string ilrFilename, string albFilename, JobContextMessage jobContextMessage, List<string> validLearners, Mock<IKeyValuePersistenceService> storage, Mock<IKeyValuePersistenceService> persist, Mock<ISerializationService> serialise)
        {
            ...
            string ilrContents, albContents;
            ...
            return new Tuple<Message, FundingOutputs>(message, fundingOutputs);
        }
    }
}
