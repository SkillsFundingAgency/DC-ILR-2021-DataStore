...
namespace ESFA.DC.ILR1819.DataStore.PersistData.Test
{
    public class TestStoreFM70
    {
        ...
        public async Task StoreFM70()
        {
            ...
            var fm70Output = await ReadAndDeserialiseAsync(fm70FileName, persist, serialise);
                ...
                new SqlConnection(ConfigurationManager.AppSettings["TestConnectionString"]))
            {
                ...
                try
                {
                    ...
                    await storeClear.ClearAsync(connection, transaction, ukprn, Path.GetFileName(fm70FileName), cancellationToken);
