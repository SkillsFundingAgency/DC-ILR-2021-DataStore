...
{
    public partial class ILR2021_DataStoreEntitiesInvalid : DbContext
    {
        public ILR2021_DataStoreEntitiesInvalid()
        {
        }

        public ILR2021_DataStoreEntitiesInvalid(DbContextOptions<ILR2021_DataStoreEntitiesInvalid> options)
            : base(options)
        {
        }
