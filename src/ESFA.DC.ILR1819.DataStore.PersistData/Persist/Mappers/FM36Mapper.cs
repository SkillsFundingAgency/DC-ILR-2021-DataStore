...
namespace ESFA.DC.ILR1819.DataStore.PersistData.Persist.Mappers
{
    public class FM36Mapper : IFM36Mapper
    {
        ...
        public AEC_global MapGlobal(FM36Global fm36Global)
        {
            return new AEC_global
            {
        ...
        {
            return fm36Global.Learners.Select(l => new AEC_Learner
            {
                UKPRN = fm36Global.UKPRN,
            ...
            for (var i = 1; i < 13; i++)
            {
                learningDeliveryPeriods.AddRange(
                    ...
                    new AEC_LearningDelivery_Period
                    {
                        ...
                        LearnDelSFAContribPct = PeriodisedValueHelper.GetPeriodValue<LearningDeliveryPeriodisedValues, int?>(pv.LearningDeliveryPeriodisedValue.FirstOrDefault(a => a.AttributeName == FM36Constants.LearnDelSFAContribPct), i),
                        ...
                        ProgrammeAimProgFundIndMaxEmpCont = PeriodisedValueHelper.GetPeriodValue<LearningDeliveryPeriodisedValues, int?>(pv.LearningDeliveryPeriodisedValue.FirstOrDefault(a => a.AttributeName == FM36Constants.ProgrammeAimProgFundIndMaxEmpCont), i),
                        ProgrammeAimProgFundIndMinCoInvest = PeriodisedValueHelper.GetPeriodValue<LearningDeliveryPeriodisedValues, int?>(pv.LearningDeliveryPeriodisedValue.FirstOrDefault(a => a.AttributeName == FM36Constants.ProgrammeAimProgFundIndMinCoInvest), i),
                        ProgrammeAimTotProgFund = PeriodisedValueHelper.GetPeriodValue<LearningDeliveryPeriodisedValues, int?>(pv.LearningDeliveryPeriodisedValue.FirstOrDefault(a => a.AttributeName == FM36Constants.ProgrammeAimTotProgFund), i),
                    }));
            }
            ...
            for (var i = 1; i < 13; i++)
            {
                learningDeliveryPeriods.AddRange(
                    ...
                    new AEC_ApprenticeshipPriceEpisode_Period
                    {
                        ...
                        Period = i,
                        PriceEpisodeApplic1618FrameworkUpliftBalancing = PeriodisedValueHelper.GetPeriodValue<PriceEpisodePeriodisedValues, int?>(pv.PriceEpisodePeriodisedValue.FirstOrDefault(a => a.AttributeName == FM36Constants.PriceEpisodeApplic1618FrameworkUpliftBalancing), i),
                        PriceEpisodeApplic1618FrameworkUpliftCompletionPayment = PeriodisedValueHelper.GetPeriodValue<PriceEpisodePeriodisedValues, int?>(pv.PriceEpisodePeriodisedValue.FirstOrDefault(a => a.AttributeName == FM36Constants.PriceEpisodeApplic1618FrameworkUpliftCompletionPayment), i),
                        PriceEpisodeApplic1618FrameworkUpliftOnProgPayment = PeriodisedValueHelper.GetPeriodValue<PriceEpisodePeriodisedValues, int?>(pv.PriceEpisodePeriodisedValue.FirstOrDefault(a => a.AttributeName == FM36Constants.PriceEpisodeApplic1618FrameworkUpliftOnProgPayment), i),
                        PriceEpisodeBalancePayment = PeriodisedValueHelper.GetPeriodValue<PriceEpisodePeriodisedValues, int?>(pv.PriceEpisodePeriodisedValue.FirstOrDefault(a => a.AttributeName == FM36Constants.PriceEpisodeBalancePayment), i),
                        PriceEpisodeBalanceValue = PeriodisedValueHelper.GetPeriodValue<PriceEpisodePeriodisedValues, int?>(pv.PriceEpisodePeriodisedValue.FirstOrDefault(a => a.AttributeName == FM36Constants.PriceEpisodeBalanceValue), i),
                        PriceEpisodeCompletionPayment = PeriodisedValueHelper.GetPeriodValue<PriceEpisodePeriodisedValues, int?>(pv.PriceEpisodePeriodisedValue.FirstOrDefault(a => a.AttributeName == FM36Constants.PriceEpisodeCompletionPayment), i),
                        PriceEpisodeFirstDisadvantagePayment = PeriodisedValueHelper.GetPeriodValue<PriceEpisodePeriodisedValues, int?>(pv.PriceEpisodePeriodisedValue.FirstOrDefault(a => a.AttributeName == FM36Constants.PriceEpisodeFirstDisadvantagePayment), i),
                        PriceEpisodeFirstEmp1618Pay = PeriodisedValueHelper.GetPeriodValue<PriceEpisodePeriodisedValues, int?>(pv.PriceEpisodePeriodisedValue.FirstOrDefault(a => a.AttributeName == FM36Constants.PriceEpisodeFirstEmp1618Pay), i),
                        PriceEpisodeFirstProv1618Pay = PeriodisedValueHelper.GetPeriodValue<PriceEpisodePeriodisedValues, int?>(pv.PriceEpisodePeriodisedValue.FirstOrDefault(a => a.AttributeName == FM36Constants.PriceEpisodeFirstProv1618Pay), i),
                        ...
                        PriceEpisodeLSFCash = PeriodisedValueHelper.GetPeriodValue<PriceEpisodePeriodisedValues, int?>(pv.PriceEpisodePeriodisedValue.FirstOrDefault(a => a.AttributeName == FM36Constants.PriceEpisodeLSFCash), i),
                        PriceEpisodeOnProgPayment = PeriodisedValueHelper.GetPeriodValue<PriceEpisodePeriodisedValues, int?>(pv.PriceEpisodePeriodisedValue.FirstOrDefault(a => a.AttributeName == FM36Constants.PriceEpisodeOnProgPayment), i),
                        PriceEpisodeProgFundIndMaxEmpCont = PeriodisedValueHelper.GetPeriodValue<PriceEpisodePeriodisedValues, int?>(pv.PriceEpisodePeriodisedValue.FirstOrDefault(a => a.AttributeName == FM36Constants.PriceEpisodeProgFundIndMaxEmpCont), i),
                        PriceEpisodeProgFundIndMinCoInvest = PeriodisedValueHelper.GetPeriodValue<PriceEpisodePeriodisedValues, int?>(pv.PriceEpisodePeriodisedValue.FirstOrDefault(a => a.AttributeName == FM36Constants.PriceEpisodeProgFundIndMinCoInvest), i),
                        PriceEpisodeSecondDisadvantagePayment = PeriodisedValueHelper.GetPeriodValue<PriceEpisodePeriodisedValues, int?>(pv.PriceEpisodePeriodisedValue.FirstOrDefault(a => a.AttributeName == FM36Constants.PriceEpisodeSecondDisadvantagePayment), i),
                        PriceEpisodeSecondEmp1618Pay = PeriodisedValueHelper.GetPeriodValue<PriceEpisodePeriodisedValues, int?>(pv.PriceEpisodePeriodisedValue.FirstOrDefault(a => a.AttributeName == FM36Constants.PriceEpisodeSecondEmp1618Pay), i),
                        PriceEpisodeSecondProv1618Pay = PeriodisedValueHelper.GetPeriodValue<PriceEpisodePeriodisedValues, int?>(pv.PriceEpisodePeriodisedValue.FirstOrDefault(a => a.AttributeName == FM36Constants.PriceEpisodeSecondProv1618Pay), i),
                        PriceEpisodeSFAContribPct = PeriodisedValueHelper.GetPeriodValue<PriceEpisodePeriodisedValues, int?>(pv.PriceEpisodePeriodisedValue.FirstOrDefault(a => a.AttributeName == FM36Constants.PriceEpisodeSFAContribPct), i),
                        PriceEpisodeTotProgFunding = PeriodisedValueHelper.GetPeriodValue<PriceEpisodePeriodisedValues, int?>(pv.PriceEpisodePeriodisedValue.FirstOrDefault(a => a.AttributeName == FM36Constants.PriceEpisodeTotProgFunding), i),
                        PriceEpisodeLearnerAdditionalPayment = PeriodisedValueHelper.GetPeriodValue<PriceEpisodePeriodisedValues, int?>(pv.PriceEpisodePeriodisedValue.FirstOrDefault(a => a.AttributeName == FM36Constants.PriceEpisodeLearnerAdditionalPayment), i),
                    }));
            }
