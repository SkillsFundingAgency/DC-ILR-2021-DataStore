...
$privateFilesPath =  [io.path]::combine($(get-item $ProjDirectory).parent.parent.parent.FullName,"DC-Configs","ServiceFabricSettings",$env:UserName,"DataService")
Write-Host $privateFilesPath 
 
$destination = [io.path]::combine($(get-item $ProjDirectory).parent.FullName,"ESFA.DC.ILR1819.DataStore","ApplicationParameters")
